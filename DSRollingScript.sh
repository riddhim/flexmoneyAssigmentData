...
#the appropriate Deployment strategy for the given use case is the Rolling Deployment Strategy as he application undergoes frequent updates, and the changes are relatively small or non-disruptive.
#as mentioned
BRANCH_NAME=$1
SERVER_IPS=$2
